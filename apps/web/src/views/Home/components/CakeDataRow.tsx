 ...
 */
const planetFinanceBurnedTokensWei = BigNumber.from('1965045600')
  ...
  return (
    <Grid>
      ...
      <StyledColumn noMobileBorder style={{ gridArea: 'c' }}>
        ...
        <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={10000000} />
      </StyledColumn>
