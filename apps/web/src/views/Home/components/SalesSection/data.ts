...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  headingText: t('Flame.'),
  bodyText: t(
    'Flame Token is the Utility Token of FlameFinance. Light Your Portfolio With Flame Token!',
  ),
  reverse: false,
  primaryButton: {
    to: 'https://pancakeswap.finance/swap?outputCurrency=0x3f2EF899eF580e6ee6202212585873E75F85C829&chainId=56',
    text: t('Buy Flame'),
    external: false,
  },
  secondaryButton: {
