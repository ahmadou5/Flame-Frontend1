...
export const DEFAULT_META: PageMeta = {
  title: 'FlameFinance',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through our new Burn to earn model.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for FlameFinance exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for FlameFinance exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for FlameFinance exchanges.' },
